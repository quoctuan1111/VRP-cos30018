...
from src.optimization.or_optimization import ORToolsOptimizer
...
from src.optimization.route_optimizer import Route
...
class CommunicationManager:
    def __init__(self, data_processor: DataProcessor):
        ...
        if data_processor is not None:
            self.optimizer = ORToolsOptimizer(data_processor)
